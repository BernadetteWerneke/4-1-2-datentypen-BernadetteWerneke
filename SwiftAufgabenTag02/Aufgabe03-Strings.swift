...
//  Die Werte, die bei readLine() rauskommen, sind Optionals. Dementsprechend brauchst du bei jeder Variable die if-Syntax, um sicherzugehen, dass sie beim printen alle befüllt sind, oder nutzt die alternative Syntax aus Zeile 19:
